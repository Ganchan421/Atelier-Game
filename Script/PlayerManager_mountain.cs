...
public class PlayerManager_mountain : MonoBehaviour
{
    //SPEED設定
    float speed;
    ...
    void Start()
    {
        ...
        CommentText.text = "北風が吹いている".ToString();
        ...
        GunText.text = "Unity砲-γ".ToString();
    ...
    void Update()
    {
        ...
        this.transform.position-=new Vector3(0,0,wind_speed*Time.deltaTime);
        Wind.transform.position = new Vector3(this.transform.position.x, this.transform.position.y + 1, this.transform.position.z + 6);
